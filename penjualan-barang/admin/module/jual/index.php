				...
				<div id="keranjang" class="table-responsive">
					<table class="table table-bordered p-10">
						<tr>
							...
							<td><b>Kasir :</b> <?php echo $_SESSION['admin']['nm_pegawai']; ?></td>
						</tr>
					</table>
					...
					<div id="kasirnya">
						<table class="table table-stripped">
								...
								if (!empty($bayar)) {
									...
									if ($bayar >= $total) {
										...
										for ($x = 0; $x < $jumlah_dipilih; $x++) {
											$d = array($id_barang[$x], $id_pegawai[$x], $jumlah[$x], $total[$x], $tgl_input[$x], $periode[$x]);
											$sql = "INSERT INTO nota (id_barang, id_pegawai, jumlah, total, tanggal_input, periode) VALUES(?,?,?,?,?,?)";
							...
							<tr>
								...
								<td></td>
								<td>
									<a href="print.php?nm_pegawai=<?php echo $_SESSION['admin']['nm_pegawai']; ?>&bayar=<?php echo $bayar; ?>&kembali=<?php echo $hitung; ?>" target="_blank">
