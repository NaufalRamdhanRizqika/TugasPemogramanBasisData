        ...
        <table class="table table-bordered table-striped table-sm" id="example1">
            ...
            <tfoot>
                <tr>
                    ...
                    <th>Rp<?php echo number_format($totalBeli, 0, '', '.'); ?></th>
                    <th>Rp<?php echo number_format($totalJual, 0, '', '.'); ?></th>
            ...
            <form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
                <div class="modal-body">
                    <table class="table table-striped bordered">
                        ...
                        <tr>
                            <td>Tanggal Input</td>
                            <td><input type="datetime-local" name="tgl" class="form-control" value="<?php echo date('Y-m-d\TH:i'); ?>" required></td>
                        </tr>
                    </table>
                </div>
