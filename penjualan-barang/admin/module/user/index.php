		...
		<div class="card card-primary">
			...
			<div class="card-footer">
				<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
					...
					<input type="hidden" name="id" value="<?php echo $hasil['id_pegawai']; ?>">
					<br><br>
						...
						<fieldset>
							<div class="control-group mb-3">
								...
								<div class="input-group">
									<input type="text" class="form-control" style="border-radius:0px;" name="nama" data-items="4" value="<?php echo $hasil['nm_pegawai']; ?>" required="required" />
								</div>
							</div>
							<div class="control-group mb-3">
							...
							<div class="control-group mb-3">
								...
								<div class="controls">
									<textarea name="alamat" rows="3" class="form-control" style="border-radius:0px;" required="required"><?php echo $hasil['alamat_pegawai']; ?></textarea>
								</div>
							</div>
							<input type="hidden" name="id" value="<?php echo $hasil['id_pegawai']; ?>">
				...
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?pass=ganti-pas">
						<fieldset>
							...
							<input type="hidden" class="form-control" style="border-radius:0px;" name="id" value="<?php echo $hasil['id_pegawai']; ?>" required="required" />
