...
if (isset($_POST['proses'])) {
	...
	$sql = 'SELECT pegawai.*, login.user, login.pass FROM pegawai INNER JOIN login ON pegawai.id_pegawai = login.id_pegawai WHERE user = ? AND pass = md5(?)';
					...
					<div class="card-body p-0">
						<div class="p-5">
							<div class="text-center">
								<h4 class="h4 text-gray-900 mb-4"><b>Login Warung Pintar</b></h4>
							</div>
